			...
			<div class="step_info" >
				...
				<ul class="step_icon"  >
					<li>
						...
						<a class="ios_btn" id="iosHref" href=" http://downloads.easemob.com/downloads/iOSSDK.zip">下载IOS版开发包（SDK+文档+Demo)</a>
					...
					<li class="li_away">
						...
						<a  id="androidHref" class="ios_btn andriod_btn" href="http://downloads.easemob.com/downloads/androidsdk.zip">下载Andriod版开发包（SDK+文档+Demo)</a>
