			...
			<div class="step_info">
				...
				<ul class="step_icon">
					...
					<li class="li_away">
						...
						<span><em><a href="/docs/android/quickstart"  target="_blank">5分钟快速入门</a> | <a href="/docs/android/singlechat" target="_blank">Android SDK 集成指南</a></em>V 2.1.0　下载次数：19315</span>
					</li>
