			...
			<div class="step_info">
				...
				<ul class="step_icon">
					...
					<li class="li_away">
						...
						<a  id="androidHref" class="ios_btn andriod_btn" onclick="_hmt.push(['_trackEvent', 'IMSDK', 'click', 'AndroidSDK'])" href="http://www.easemob.com/downloads/easemob-sdk-2.1.7.zip">下载Andriod版开发包（SDK+文档+Demo)</a>
