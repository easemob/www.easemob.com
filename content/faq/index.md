    ...
    <div id="container" class="faq_con">
      ...
      <div class="faq_items">
        <dl>
          ...
          <dd>
            <span></span>
            <p>环信是国内最领先的即时通讯云平台, 只需在手机端加入几行代码就可以帮助APP快捷的接入类似微信的即时通讯功能。比如单聊（发语音，发图片，发位置等)，群聊，实时音频视频等。截止14年9月30日，环信已经接入了7002家APP，环信SDK覆盖注册用户7000万，过千万用户的超级app有10多家。所以环信既是国内第一家即时通讯云平台，也是国内规模最大的即时通讯云平台。环信的典型用户包括海豚浏览器，蜻蜓fm，汽车之家-车友会，节操精选，看动漫，哈图，熊猫公交等。</p>
            </dd>
          ...
          <dt id="section-9"><a href="#section-9">环信有没有推送接口？我的APP以前使用了其他的第三方推送，我们需要替换成环信吗</a></dt>
          <dd>
            <span></span>
          ...
          <dt id="section-10"><a href="#section-10">我们要对聊天内容进行敏感字控制的话怎么实现？</a></dt>
          <dd>
            <span></span>
