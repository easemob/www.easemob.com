...
##### 客服代表
指一个客服系统中处理客户会话的工作人员。一个客服系统中可以有多个客服，每个客服具有和客户进行会话交流、标记客户标签、维护客户信息、做会话小结等操作权限。

##### 关联
关联是指一个客服系统和即时通讯系统的连接设置，集成过程中，先在app中集成环信的IM系统，并提供一个联系客服的入口，入口中设置客户访问时可以和一个固定的环信ID进行会话，然后在客服系统中设置关联的AppKey以及对应的环信ID，设置以后，所有和此ID进行的会话都会分配到客服系统，客服系统将会话分配到客服处理。


## 1. 注册登录
打开浏览器，输入[http://kefu.easemob.com/register](http://kefu.easemob.com/register) ，或者在环信官网的客服产品页面中点击申请体验，进入如下界面。

&ltcenter>![注册界面](/img/kefu/1.bmp)</center>
<center>注册界面</center>
...
&ltcenter>![数据信息详解](/img/kefu/2.png)</center>
...
&ltcenter>![客服列表](/img/kefu/3.png)</center>
<center>客服列表</center>

点击“新增客服”按钮，在弹出的界面中输入客服信息，并保存，完成新增客服操作。


&ltcenter>![新增客服](/img/kefu/4.png)</center>
<center>新增客服</center>
...
&ltcenter>![环信开发者中心](/img/kefu/5.png)</center>
<center>环信开发者中心</center>

打开应用的详细信息，如下图：

&ltcenter>![详细信息](/img/kefu/6.png)</center>
<center>详细信息</center>
...
&ltcenter>![正确配置](/img/kefu/8.png)</center>
<center>正确配置</center>

&ltcenter>![正确配置](/img/kefu/9.png)</center>
<center>错误配置</center>
...
&ltcenter>![个人设置](/img/kefu/10.png)</center>
<center>个人设置</center>
...
&ltcenter>![设置访客分类标签1](/img/kefu/11.png)</center>
<center> 设置访客分类标签</center>

&ltcenter>![设置访客分类标签2](/img/kefu/12.png)</center>
...
&ltcenter>![设置会话小结](/img/kefu/13.png)</center>

<center> 设置会话小结</center>

结束会话时，需要选择会话小结，来给本次会话做一个标记，方便日后统计分析及跟踪客户需求

&ltcenter>![使用会话小结](/img/kefu/14.png)</center>
